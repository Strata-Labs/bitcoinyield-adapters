...
test("uses only fresh NAV chains for the headline APY while keeping total TVL", () => {
  ...
  ) => { tvlBtc: number; apy7d: number; freshTvlBtc: number };

  const result = aggregateSnapshots([
    { tvlBtc: 48, apy7d: 3.23, navTime: 1_782_691_200, isFresh: true },
    { tvlBtc: 158, apy7d: 3.23, navTime: 1_782_691_200, isFresh: true },
    { tvlBtc: 0.7, apy7d: 0, navTime: 1_770_681_600, isFresh: false },
  ]);
