/**
 * Maple Finance BTC Yield adapter.
 * Two GraphQL queries: poolV2 for APY, nativePoolById for BTC-denominated TVL.
 *
 * Maple returns weeklyApy/monthlyApy as bigint-scaled-by-10^30, and tvlNative
...
const TVL_QUERY = `
  query GetNativePool($nativePoolId: String!) {
    nativePoolById(nativePoolId: $nativePoolId) {
    ...
    return [
      {
        ...
        metadata: {
          weeklyApy: math.toPercent(weeklyApy),
          monthlyApy: math.toPercent(monthlyApy),
          maturityDate: native.nextEligibleMaturityBtcYieldDate ?? null,
          poolId: POOL_ID,
          nativePoolId: NATIVE_POOL_ID,
        },
      },
